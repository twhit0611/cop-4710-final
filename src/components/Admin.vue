                            ...
                            <v-container>
                                <v-row>
                                    <v-col cols="12" sm="6" md="4">
                                        <v-text-field label="RSO*" required></v-text-field>
                                    </v-col>
                                    <!-- Has to be definite RSO tied with admin account 
                                    or can the admin have different RSO and then be 
                                    able to choose which on  -->
                                    <v-col cols="12" sm="6" md="4">
